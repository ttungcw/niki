...
function Shop() {
    ...
    return (
        <div className={cx('wrapper')}>
            <section className={cx('sidebar')} style={{ display: showSidebar }}>
                ...
                <form className={cx('brand')}>
                    <h4>Brand</h4>
                    <div className={cx('sidebar__item')} onChange={handleBrand}>
                        <input
                            type="checkbox"
                            id="nikesport"
                            name="nikesport"
                ...
                <form className={cx('price')}>
                    ...
                    <div className={cx('sidebar__item')} onChange={handlePrice}>
                        <input
                            type="checkbox"
                            id="price2"
                            name="price2"
                ...
                <div className={cx('title')}>
                    ...
                    <div className={cx('tools')}>
                        ...
                        <div className={cx('sort')}>
                            <label htmlFor="sort">Sort By {selection}</label>
                            <select
                                name="sort"
                                id="sort"
